...
*Note that in newer versions of QIIME2, the 'D_1__' will need to be changed to just 'd__'*
```{bash, eval=FALSE}
...
def nmds_plot_study_env(dist_matr_fn_w, dist_matr_fn_uw, meta_dict, basedir, n_jobs=1, save_name='/figures/Fig2_nmds_overall_', stats=False, norm_name='rare'):
    ...
    if norm_name == 'clr':
      ...
      ylabs, xlabs = [r'$\bf{Weighted}$ $\bf{unifrac}$ $\bf{distance}$'+'\nnMDS2', '', r'$\bf{Unweighted}$ $\bf{unifrac}$ $\bf{distance}$'+'\nnMDS2', ''], ['', '', 'nMDS1', 'nMDS1']
...
![](/Users/robynwright/Documents/OneDrive/Papers_writing/Plastisphere_Meta-analysis/test_recreate_analyses/paper_data/figures/Fig3_unifrac_heatmap_combined_rare.png)
